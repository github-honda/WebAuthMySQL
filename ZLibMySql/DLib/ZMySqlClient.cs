...
namespace ZLib.DLib
{
    public class ZMySqlClient : ZADB, IDisposable
    {
        protected MySqlConnection mConnection;
        protected MySqlTransaction mTransaction; // connection level.
        public ZMySqlClient(string sConnectionString)
        ...
        {
            if (mConnection == null)
                mConnection = new MySqlConnection(msConnection);
        ...
        public string FetchString(MySqlDataReader reader, int iField)
        {
        ...
        public string FetchString(MySqlDataReader reader, string sColName)
        {
            return FetchString(reader, sColName, string.Empty);
        }
        public string FetchString(MySqlDataReader reader, string sColName, string sDefaultValue)
        {
        ...
        public string[] FetchStrings(MySqlDataReader reader)
        {
